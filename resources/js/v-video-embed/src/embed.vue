<template>
    ...
    <div class="embed-responsive embed-responsive-21by9" :class="[css]" v-if="valid">
        <iframe loading="lazy" 
            sandbox="allow-forms allow-scripts allow-pointer-lock allow-same-origin allow-top-navigation allow-presentation"
            class="embed-responsive-item" rel="0" allowfullscreen :src="url"
            style="width: 100%" height="400"></iframe>
    </div>
